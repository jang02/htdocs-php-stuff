...
define('DB_NAME', 'rpg-game'); // Wat is de database naam
define('DB_USER', 'root'); 		// Wat is de database gebruiker
define('DB_PASS', 'yLNsly8hPL3CQD2a');		// Wat is het database wachtwoord
...
define('DEFAULT_CONTROLLER', 'login'); 			// Dit is de standaard controller waarmee de webapplictie wordt opgestart

define('GAME_NAME', "RPG-Game");
